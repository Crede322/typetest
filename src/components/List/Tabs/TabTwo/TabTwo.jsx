...
import classes from "./TabTwo.module.css";
...
const TabTwo = () => {
    ...
    const {setLastKey} = useContext(TabContext);
...
const stateSetterName = `setColorState${keyCode}`;
  ...
  if (setColorState) {
    setColorState('rgba(0, 39, 211, 0.7)');
  }
...
return (
    <div>
            <div className={classes.tabTwo__wrapper}>
                <div className={classes.keyboard}>
                    ...
                    <ul className={classes.keyRow}>
                        ...
                        <Keys
                            ...
                            width={data.width}
                        />))}
                        <div><img src={stateObjects.colorState13 === 'rgba(0, 39, 211, 0.7)' ? enterColored : enter} alt="Enter" className={classes.enter}/></div>
                    </ul>
